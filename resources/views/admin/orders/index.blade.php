                                ...
                                <div class="dt-buttons btn-group flex-wrap" style="">
                                    ...
                                    <div id="DataTables_Table_1_filter" class="pull-right dataTables_filter"
                                        ...
                                        <select name="status" aria-controls="DataTables_Table_3"
                                            ...
                                            <option value="pending"     {{ Request::get('status') == 'pending' ? 'selected' : ''}}>Chờ duyệt</option>
                                            <option value="in progress" {{ Request::get('status') == 'in progress' ? 'selected' : ''}}>Đang giao</option>
                                            <option value="completed"   {{ Request::get('status') == 'completes' ? 'selected' : ''}}>Đã giao</option>
                                            <option value="cancelled"   {{ Request::get('status') == 'canceled' ? 'selected' : ''}}>Bị huỷ</option>
                                        </select> 
                                    </div>
                            ...
                            <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_2_paginate">
                                <ul class="pagination">
                                    <li class="paginate_button page-item previous disabled"
                                        ...
                                        <a href="#" aria-controls="DataTables_Table_2" data-dt-idx="0"
                                            tabindex="0" class="page-link"><i class="ion-chevron-left"></i></a>
                                    </li>
