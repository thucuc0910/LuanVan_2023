                    ...
                    <div class="col-lg-8 ">
                        <div class="border rounded-2 px-3 py-2 bg-white ">
                            <div class="pd-20 card-box mb-30">
                                ...
                                <form action="{{ url('user/profile/editAddress/' . $address->id) }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Tỉnh</label>
                                                <select class="form-control user_city choose" name="user_city"
                                                    id="city">
                                                    <option value="">------------------------------------Chọn
                                                        tỉnhthànhphố--------------------------------------------------------
                                                    </option>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control user_district choose" name="user_district"
                                                    id="district">
                                                    <option value="">
                                                        ------------------------------------Chọn
                                                        Quận/Huyện----------------------------------------------------------
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $address->detail }}" type="text" name="user_street"
                                                    class="user_street form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input value='1' {{ $address->status == '1' ? 'checked=""' : '' }}
                                                    type="checkbox" name="status" style="width: 30px; height: 30px"
                                                    class="status">
                                            </div>
                                        </div>
                                        @error('status')
